-- Migration 0069: Remove region filter from fn_get_churches_simple
-- The API layer handles region filtering, so the RPC should return ALL approved churches
...
BEGIN
  ...
  WHERE c.approved = true
    -- NO REGION FILTER HERE - API layer handles this
...
COMMENT ON FUNCTION fn_get_churches_simple IS 'Returns ALL approved churches. Region filtering is handled by the API layer.';
