-- Migration: Update fn_get_churches to support collaboration filters
-- Sprint 1.7: Add collab_have and collab_need array filtering
...
COMMENT ON FUNCTION fn_get_churches IS 'Returns approved churches with location as GeoJSON, optionally filtered by search term, denomination, and collaboration tags (using array overlap)';
