-- Function to get churches within a bounding box WITH extracted coordinates
-- This solves the issue where PostGIS geography columns return null via REST API
-- Uses ST_X and ST_Y to extract coordinates directly from PostGIS
